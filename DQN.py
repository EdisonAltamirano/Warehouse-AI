...
class DQNAgent(torch.nn.Module):
    ...
    def get_state(self, game, player, food):
        ...
        state = [
            ...
            #player1
            player.status == 1,  # Robot is moving
            player.status == 2,  # Robot is charging
            player.status == 3,  # Robot is free
            player.battery > 40,  # Battery > 50
    ...
    def set_reward(self, player, crash):
        ...
        Return the reward.
        The reward is:
            -10 when Robots battery is < 50. 
            -10 when Robots battery is > 100. 
            +10 when Robots gets to Objective
            0 otherwise
        """
        self.reward = 0
        if crash:
            ...
            self.reward= -10
            return self.reward
        elif player.battery<=30 and player.battery>=90:
            self.reward= -10
            return self.reward
        return self.reward
        #return self.reward
